...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<object> result = Emps.GroupBy(e => e.Job).Select(e => new {Praca = e.Key, LiczbaPracownikow = e.Count()}).ToList();
            return result;
        }
        ...
        {
            IEnumerable<object> result = Emps.Select(e => new {e.Ename, e.Job, e.HireDate }).Union(
                Emps.Select(e => new {Ename = "Brak wartości", Job = string.Empty, HireDate = (DateTime?)null })).ToList();
            return result;
        }
        ...
        public static IEnumerable<object> Task11()
        {
            IEnumerable<object> result = Emps
                ...
                .GroupBy(o => o.Dname)
                .Where(o => o.Count() > 1)
                .Select(o => new {name = o.Key, numOfEmployees = o.Count()});
            return result;
        }
        ...
        {
            int result = arr.GroupBy(n => n).Where(n => n.Count() % 2 == 1).Select(n => n.Key).First();
            //result=
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Depts
                ...
                .Where(d => d.count == 0 || d.count == 5)
                .Select(d => d.dept).ToList();
            return result;
        }
    }
    ...
    public static class CustomExtensionMethods
    {
        ...
        {
            return emps.Where(e => emps.Any(e2 => e2.Mgr == e)).OrderBy(e => e.Ename).ThenByDescending(e => e.Salary);
        }
